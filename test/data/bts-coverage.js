function Demo_BTSCoverage() {}

Demo_BTSCoverage.getData = function() {
    var germany_data = [
...
[13.712445,51.049657,'2533m','warning','GSM'],
    ...
    for (var i = 0; i < 30; i++) {
        for (var j = 0; j < 15; j++) {
            var topLeft = [13.768923 + i * 0.0014, 51.062911 - j * 0.0020];
            var bottomRight = [13.768923 + (i + 1) * 0.0014, 51.062911 - (j + 1) * 0.0020];
            var RSRP = [getRandom(50, 140) * -1, getRandom(2, 100)];
            geotile_data.push(topLeft.concat(bottomRight).concat(RSRP));
        }
    }
    ...
    return germany_data.slice(0, 200);
}
